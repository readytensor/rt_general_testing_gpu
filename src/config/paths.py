...
TRAIN_DIR = os.path.join(INPUT_DIR, "data", "training")
# Path to test directory inside data directory
TEST_DIR = os.path.join(INPUT_DIR, "data", "testing")
# Path to schema dir inside inputs directory
SCHEMA_DIR = os.path.join(INPUT_DIR, "schema")
# Path to image classification training directory
TRAIN_DIR_IMG_CLASS = os.path.join(INPUT_DIR, "training")

TEST_DIR_IMG_CLASS = os.path.join(INPUT_DIR, "testing")
